        ...
        for (Cosmetic cosmetic : ((Main) this.module.getParent()).getApi().getCosmetics(CosmeticType.PARTICLE)) {
            ...
            switch (pcs.getShape()) {
                ...
                case DOUBLEHELIX:
                    ...
                    break;
                case RANDOM:
                    Methods.broadcastSafeParticle(p.getLocation(), pcs.getParticle(), pcs.getId(), pcs.getData(), 0.5F, 0.5F, 0.5F, pcs.getSpeed(), 16, ((Particles) this.module.getConfig()).getViewDistance());
                    break;
                case TRAIL:
