 ...
 * @since 12/03/2016
 */
public final class Pet extends Cosmetic {
    private Creature entity;

    public Pet(CosmeticConfig cosmeticConfig, Player player, EntityCosmeticStorage cosmeticStorage) {
        super(cosmeticConfig, player, cosmeticStorage, CosmeticType.PET);
    }
